...
const allProducts: Record<string, Product[]> = {
  "book-shelves": withIds([
    { name: "Modern Book Shelf", image: modern, price: 4999 },
    { name: "Wooden Book Rack", image: wooden, price: 3499 },
  ]),
  "sofas": withIds([
    { name: "Luxe Sofa Set", image: sofa1, price: 15999, oldPrice: 18999 },
    { name: "Fabric Recliner", image: sofa2, price: 9999 },
  ]),
  "dining-table": withIds([
    { name: "Classic Dining Table", image: "/images/dining1.jpg", price: 8999 },
  ]),
  "tv-units": withIds([
    { name: "TV Cabinet Premium", image: tv1, price: 5499 },
  ]),
  "study-table": withIds([
    { name: "Compact Study Table", image: "/images/studytable1.jpg", price: 2999 },
  ]),
  "benches": withIds([
    { name: "Classic Wooden Bench", image: bench1, price: 1999 },
    { name: "Modern Bench", image: bench2, price: 999 },
    { name: "Vintage Bench", image: bench3, price: 3999 },
    { name: "Urban Wooden Bench", image: bench4, price: 4999 },
    { name: "Kaba Upholestered Bench", image: bench5, price: 5999 },
  ]),
  "coffee-tables": withIds([
    { name: "Rustic Charm Coffee Table", image: ct1, price: 7999 },
    { name: "Arvo Round Center Table", image: ct2, price: 9999 },
    { name: "Halo Oval Table", image: ct3, price: 6999 },
    { name: "Reclaimed Timber Table", image: ct4, price: 8999 },
    { name: "UrbanNest Coffee Table", image: ct5, price: 10999 },
  ]),
  "console-tables": withIds([
    { name: "Nova Slim Console", image: console1, price: 7999 },
    { name: "Driftwood Console Table", image: console2, price: 9999 },
    { name: "Woodcraft Console", image: console3, price: 6999 },
    { name: "Rustic Grove Console", image: console4, price: 9999 },
    { name: "Vintage Console", image: console5, price: 12999 },
  ]),
  "lounge-chairs": withIds([
    { name: "TimberNest Lounge Chair", image: lg1, price: 7999 },
    { name: "RusticCharm Armchair", image: lg2, price: 9999 },
    { name: "Woodcraft Lounge Chair", image: lg3, price: 6999 },
    { name: "Halo Mid-Century Chair", image: lg4, price: 9999 },
    { name: "Vintage Lounge Chair", image: lg5, price: 12999 },
  ]),
  "poufs": withIds([
    { name: "TimberNest Pouf", image: pf1, price: 7999 },
    { name: "RusticCharm Pouf", image: pf2, price: 9999 },
    { name: "Woodcraft Lounge Pouf", image: pf3, price: 6999 },
    { name: "Halo Mid-Century Pouf", image: pf4, price: 9999 },
    { name: "Vintage Lounge Pouf", image: pf5, price: 12999 },
  ]),
  "side-tables": withIds([
    { name: "TimberNest Side-Table", image: st1, price: 7999 },
    { name: "RusticCharm Side-Table", image: st2, price: 9999 },
    { name: "Woodcraft Lounge Side-Table", image: st3, price: 6999 },
    { name: "Halo Mid-Century Side-Table", image: st4, price: 9999 },
    { name: "Vintage Lounge Side-Table", image: st5, price: 12999 },
  ]),
};
