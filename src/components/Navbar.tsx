    ...
    return (
        <>
            <header className="bg-[#f5f1ed] shadow-md sticky top-0 z-50">
                ...
                {showDropdown && (
                    <div
                        className="absolute left-0 right-0 bg-white z-40 py-10 border-t border-gray-200"
                    ...
                    >
                        <div className="max-w-[1440px] mx-auto px-10 flex items-start justify-between">
                            {/* Categories Row */}
                            <div className="flex flex-row gap-12 w-full pr-8">
                                {categories.map((category, idx) => (
                                    <div key={idx} className="flex flex-col justify-start items-start leading-none">
                                        <span className="text-xs font-semibold text-gray-800 uppercase tracking-widest mb-2 leading-none">
                                            {category.title}
                                        </span>
