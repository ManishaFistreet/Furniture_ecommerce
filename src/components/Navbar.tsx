        ...
        >
          <div className="max-w-[1440px] mx-auto px-10 flex items-start justify-start gap-8">
            ...
            <div className="w-[300px] flex-shrink-0">
              <img src={Furniture} alt="Furniture Showcase" className="w-full h-auto object-cover rounded-md" />
            </div>
          </div>
        </div>
      )}
                ...
                <div className="ml-4 mt-2 mb-4">
                  {categories.map((category, catIdx) => (
                    <div key={catIdx} className="mb-3">
                      <h4 className="text-sm font-semibold text-gray-800 uppercase">{category.title}</h4>
